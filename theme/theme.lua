...
theme.pfp = gsurface.load_uncached(local_dir .. "theme/assets/pfp.jpg")
...
-- Video wallpaper
theme.video_wallpaper_path = HOME .. "/Videos/aniwalls/forest.mp4"
theme.video_wallpaper_vertical_path = HOME .. "/Videos/aniwalls/forest.mp4"
