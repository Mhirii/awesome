...
awful_keyboard.append_global_keybindings {
    ...
    { modkey }, "F2", function()
        spawn.with_shell("$HOME/.config/awesome/scripts/colorpicker.sh")
    end, {
...
awful_keyboard.append_global_keybindings {
    ...
    { modkey }, "c", function()
        spawn.with_shell("code --password-store='gnome'")
    end, {
